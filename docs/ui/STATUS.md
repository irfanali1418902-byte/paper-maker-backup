...
## NEXT TASK → **UI-045** (display / hero type step). **UI-041 is DONE — re-review PASSED 2026-08-07 at round 4. UI-044a and UI-044b are done too, and all three shipped nothing visible.**
